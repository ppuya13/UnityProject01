...
type PlayerAttackName int32

const (
	PlayerAttackName_PLAYER_ATTACK_UNKNOWN PlayerAttackName = 0
	PlayerAttackName_COMBO_01              PlayerAttackName = 1
	PlayerAttackName_COMBO_02              PlayerAttackName = 2
	PlayerAttackName_COMBO_03              PlayerAttackName = 3
	PlayerAttackName_COMBO_04              PlayerAttackName = 4
)

// Enum value maps for PlayerAttackName.
var (
	PlayerAttackName_name = map[int32]string{
		0: "PLAYER_ATTACK_UNKNOWN",
		1: "COMBO_01",
		2: "COMBO_02",
		3: "COMBO_03",
		4: "COMBO_04",
	}
	PlayerAttackName_value = map[string]int32{
...
func (x PlayerAttackName) Enum() *PlayerAttackName {
	p := new(PlayerAttackName)
	*p = x
	return p
}

func (x PlayerAttackName) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PlayerAttackName) Descriptor() protoreflect.EnumDescriptor {
	return file_messages_proto_enumTypes[1].Descriptor()
}

func (PlayerAttackName) Type() protoreflect.EnumType {
	return &file_messages_proto_enumTypes[1]
}

func (x PlayerAttackName) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PlayerAttackName.Descriptor instead.
func (PlayerAttackName) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	MonsterState_MONSTER_STATUS_DIE     MonsterState = 7
)
...
const (
	...
	// 11~20 근거리 공격
	AttackType_MONSTER_ATTACK_SHORT_RANGE_01 AttackType = 11
	AttackType_MONSTER_ATTACK_SHORT_RANGE_02 AttackType = 12
	AttackType_MONSTER_ATTACK_SHORT_RANGE_03 AttackType = 13
	// 21~30 중거리 공격
	AttackType_MONSTER_ATTACK_MID_RANGE_01 AttackType = 21
	// 31~40 원거리 공격
	AttackType_MONSTER_ATTACK_LONG_RANGE_01 AttackType = 31
	// 41~50 초장거리 공격
	AttackType_MONSTER_ATTACK_EXTRA_RANGE_01 AttackType = 41
)
...
var (
	AttackType_name = map[int32]string{
		...
		11: "MONSTER_ATTACK_SHORT_RANGE_01",
		12: "MONSTER_ATTACK_SHORT_RANGE_02",
		13: "MONSTER_ATTACK_SHORT_RANGE_03",
		21: "MONSTER_ATTACK_MID_RANGE_01",
		31: "MONSTER_ATTACK_LONG_RANGE_01",
		41: "MONSTER_ATTACK_EXTRA_RANGE_01",
	}
...
const (
	SoundType_UNKNOWN     SoundType = 0
	SoundType_SWORD_SWING SoundType = 1
	SoundType_KICK        SoundType = 2
	SoundType_SWORD_HIT   SoundType = 3
	SoundType_KICK_HIT    SoundType = 4
	SoundType_CAST        SoundType = 5
	SoundType_GUARD       SoundType = 6
)
...
func (x *GameMessage) GetSetPlayerAttack() *SetPlayerAttack {
	if x, ok := x.GetPayload().(*GameMessage_SetPlayerAttack); ok {
		return x.SetPlayerAttack
	}
	return nil
}
...
type GameMessage_SetPlayerAttack struct {
	SetPlayerAttack *SetPlayerAttack `protobuf:"bytes,14,opt,name=set_player_attack,json=setPlayerAttack,proto3,oneof"`
}
...
func (*GameMessage_SetPlayerAttack) isGameMessage_Payload() {}
...
type SetPlayerAttack struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PlayerId    string           `protobuf:"bytes,1,opt,name=player_id,json=playerId,proto3" json:"player_id,omitempty"`
	AttackName  PlayerAttackName `protobuf:"varint,2,opt,name=attack_name,json=attackName,proto3,enum=game.PlayerAttackName" json:"attack_name,omitempty"`
	AttackIndex int32            `protobuf:"varint,3,opt,name=attack_index,json=attackIndex,proto3" json:"attack_index,omitempty"`
}

func (x *SetPlayerAttack) Reset() {
	*x = SetPlayerAttack{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetPlayerAttack) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetPlayerAttack) ProtoMessage() {}

func (x *SetPlayerAttack) ProtoReflect() protoreflect.Message {
	mi := &file_messages_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetPlayerAttack.ProtoReflect.Descriptor instead.
func (*SetPlayerAttack) Descriptor() ([]byte, []int) {
	return file_messages_proto_rawDescGZIP(), []int{17}
}

func (x *SetPlayerAttack) GetPlayerId() string {
	if x != nil {
		return x.PlayerId
	}
	return ""
...
func (x *SetPlayerAttack) GetAttackName() PlayerAttackName {
	if x != nil {
		return x.AttackName
	}
	return PlayerAttackName_PLAYER_ATTACK_UNKNOWN
}

func (x *SetPlayerAttack) GetAttackIndex() int32 {
	if x != nil {
...
type MonsterTakeDamage struct {
	...
	SoundType SoundType `protobuf:"varint,4,opt,name=sound_type,json=soundType,proto3,enum=game.SoundType" json:"sound_type,omitempty"` //맞았을 때 재생할 사운드
}
...
func (x *MonsterTakeDamage) GetSoundType() SoundType {
	if x != nil {
		return x.SoundType
	}
...
var file_messages_proto_rawDesc = []byte{
	...
	0x12, 0x04, 0x67, 0x61, 0x6d, 0x65, 0x22, 0xcc, 0x08, 0x0a, 0x0b, 0x47, 0x61, 0x6d, 0x65, 0x4d,
	...
	,
	...
	0x0a, 0x01, 0x7a, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01, 0x7a, 0x22, 0x24, 0x0a, 0x04,
	...
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x0f, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x53, 0x74, 0x61, 0x72, 0x74, 0x65, 0x64, 0x22, 0x5c, 0x0a, 0x0c, 0x4c, 0x6f, 0x67,
	...
	0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x20, 0x0a, 0x0c, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x75, 0x73,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x67, 0x61, 0x6d,
	0x65, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xa9, 0x01, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69,
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x69, 0x64,
	...
	0x67, 0x61, 0x6d, 0x65, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x67, 0x61, 0x6d, 0x65, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x23,
	0x0a, 0x0d, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x22, 0x0b, 0x0a, 0x09, 0x47, 0x61, 0x6d, 0x65, 0x53, 0x74, 0x61, 0x72, 0x74,
	...
	0x67, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x06, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x22, 0x72, 0x0a, 0x0b, 0x50, 0x6c,
	0x61, 0x79, 0x65, 0x72, 0x53, 0x70, 0x61, 0x77, 0x6e, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61,
	...
	0x6d, 0x65, 0x12, 0x2a, 0x0a, 0x07, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x67, 0x61, 0x6d, 0x65, 0x2e, 0x50, 0x6c, 0x61, 0x79, 0x65,
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x07, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x22, 0x59,
	0x0a, 0x10, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x41, 0x74, 0x74, 0x61, 0x63, 0x6b, 0x41, 0x6e,
	0x69, 0x6d, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	...
	0x61, 0x73, 0x68, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x05, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x22, 0x38, 0x0a, 0x0a, 0x50, 0x6c, 0x61,
	...
	0x61, 0x6d, 0x65, 0x22, 0x2c, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x71,
	...
	0x64, 0x22, 0x4f, 0x0a, 0x0e, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	,
	...
	,
...
var file_messages_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_messages_proto_goTypes = []any{
	(PlayerActionType)(0),         // 0: game.PlayerActionType
	(PlayerAttackName)(0),         // 1: game.PlayerAttackName
	(KnockBackType)(0),            // 2: game.KnockBackType
	(ParameterType)(0),            // 3: game.ParameterType
	(ActionType)(0),               // 4: game.ActionType
	(MonsterState)(0),             // 5: game.MonsterState
	(AttackType)(0),               // 6: game.AttackType
	(SoundType)(0),                // 7: game.SoundType
	(*GameMessage)(nil),           // 8: game.GameMessage
	(*GoVector3)(nil),             // 9: game.GoVector3
	(*Ping)(nil),                  // 10: game.Ping
	(*Pong)(nil),                  // 11: game.Pong
	(*ServerStarted)(nil),         // 12: game.ServerStarted
	(*LoginRequest)(nil),          // 13: game.LoginRequest
	(*LoginResponse)(nil),         // 14: game.LoginResponse
	(*GameStart)(nil),             // 15: game.GameStart
	(*ChatMessage)(nil),           // 16: game.ChatMessage
	(*PlayerSpawn)(nil),           // 17: game.PlayerSpawn
	(*PlayerAttackAnim)(nil),      // 18: game.PlayerAttackAnim
	(*PlayerInfo)(nil),            // 19: game.PlayerInfo
	(*LogoutRequest)(nil),         // 20: game.LogoutRequest
	(*LogoutResponse)(nil),        // 21: game.LogoutResponse
	(*PlayerInput)(nil),           // 22: game.PlayerInput
	(*AnimatorParams)(nil),        // 23: game.AnimatorParams
	(*DodgeAnimParams)(nil),       // 24: game.DodgeAnimParams
	(*SetPlayerAttack)(nil),       // 25: game.SetPlayerAttack
	(*MonsterPositionUpdate)(nil), // 26: game.MonsterPositionUpdate
	(*MonsterSpawn)(nil),          // 27: game.MonsterSpawn
	(*MonsterAnim)(nil),           // 28: game.MonsterAnim
	(*MonsterAction)(nil),         // 29: game.MonsterAction
	(*MonsterTakeDamage)(nil),     // 30: game.MonsterTakeDamage
}
var file_messages_proto_depIdxs = []int32{
	13, // 0: game.GameMessage.login_request:type_name -> game.LoginRequest
	14, // 1: game.GameMessage.login_response:type_name -> game.LoginResponse
	20, // 2: game.GameMessage.logout_request:type_name -> game.LogoutRequest
	21, // 3: game.GameMessage.logout_response:type_name -> game.LogoutResponse
	15, // 4: game.GameMessage.game_start:type_name -> game.GameStart
	16, // 5: game.GameMessage.chat_message:type_name -> game.ChatMessage
	10, // 6: game.GameMessage.ping:type_name -> game.Ping
	11, // 7: game.GameMessage.pong:type_name -> game.Pong
	22, // 8: game.GameMessage.player_input:type_name -> game.PlayerInput
	17, // 9: game.GameMessage.player_spawn:type_name -> game.PlayerSpawn
	18, // 10: game.GameMessage.player_attack_anim:type_name -> game.PlayerAttackAnim
	25, // 11: game.GameMessage.set_player_attack:type_name -> game.SetPlayerAttack
	27, // 12: game.GameMessage.monster_spawn:type_name -> game.MonsterSpawn
	26, // 13: game.GameMessage.monster_position_update:type_name -> game.MonsterPositionUpdate
	28, // 14: game.GameMessage.monster_anim:type_name -> game.MonsterAnim
	29, // 15: game.GameMessage.monster_action:type_name -> game.MonsterAction
	30, // 16: game.GameMessage.monster_take_damage:type_name -> game.MonsterTakeDamage
	12, // 17: game.GameMessage.server_started:type_name -> game.ServerStarted
	19, // 18: game.PlayerSpawn.players:type_name -> game.PlayerInfo
	0,  // 19: game.PlayerInput.player_action_type:type_name -> game.PlayerActionType
	9,  // 20: game.PlayerInput.position:type_name -> game.GoVector3
	9,  // 21: game.PlayerInput.velocity:type_name -> game.GoVector3
	9,  // 22: game.PlayerInput.rotation:type_name -> game.GoVector3
	9,  // 23: game.PlayerInput.knockback:type_name -> game.GoVector3
	23, // 24: game.PlayerInput.params:type_name -> game.AnimatorParams
	24, // 25: game.PlayerInput.dodge_params:type_name -> game.DodgeAnimParams
	1,  // 26: game.SetPlayerAttack.attack_name:type_name -> game.PlayerAttackName
	9,  // 27: game.MonsterPositionUpdate.position:type_name -> game.GoVector3
	3,  // 28: game.MonsterAnim.parameter_type:type_name -> game.ParameterType
	4,  // 29: game.MonsterAction.action_type:type_name -> game.ActionType
	5,  // 30: game.MonsterAction.monster_state:type_name -> game.MonsterState
	6,  // 31: game.MonsterAction.attack_type:type_name -> game.AttackType
	9,  // 32: game.MonsterAction.destination:type_name -> game.GoVector3
	7,  // 33: game.MonsterTakeDamage.sound_type:type_name -> game.SoundType
...
func file_messages_proto_init() {
	...
	file_messages_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*GameMessage_SetPlayerAttack)(nil),
